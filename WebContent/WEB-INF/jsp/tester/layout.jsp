...
<html dir="ltr">    
	<head>    
	    ...
	    <link rel="stylesheet" type="text/css" href="${pageContext.servletContext.contextPath}/static/matrix-admin-master/assets/libs/chart-new/Chart.min.css">
	...
	<body>   
		...
		<script src="${pageContext.servletContext.contextPath}/static/matrix-admin-master/assets/libs/toastr/toastr.js"></script>
		<script src="${pageContext.servletContext.contextPath}/static/matrix-admin-master/assets/libs/chart-new/Chart.bundle.js"></script>
