...
<script type="text/javascript">
	...
	function testCaseCancelButtonHandler (e) {
		...
		//  url: "${pageContext.servletContext.contextPath}/testManager/listDatesTaskTestCasesExecuted.htm", executionDate field
		/* 
			var dataOp = { 
		...
		*/
		...
		var dataOp = { 
		"taskId": currentTaskId,
		"executionDate":some selected shit in new date format
	...
	*/
    	...
    	$.ajax({
            ...
            success: function (response) {
            	...
            	if(obj && obj.STS == '200') {
            		var optionData = [
            			{
            				executionDate: "Mar 25, 2020"
            			},
            			{
            				executionDate: "Mar 26, 2020"
            			},
            			{
            				executionDate: "Mar 27, 2020"
            			},
            			{
            				executionDate: "Mar 28, 2020"
            			},
            			{
            				executionDate: "Mar 29, 2020"
            			}
            		];
	...
	function fetchHistoryExecutionData (data) {
		showLoader(true);
		var dateData = data
    	$.ajax({
            type: "POST",
            ...
            success: function (response) {
            	...
            	if(obj && obj.STS == '200') {
            		...
            		} else if(data === "Mar 26, 2020") {
            			chartData = {
            				executionDate: data,
               				passedTests: 10,
               				failedTests: 4
               			}
            		} else if(data === "Mar 27, 2020") {
            			chartData = {
            				executionDate: data,
               				passedTests: 8,
               				failedTests: 6
               			}
            		} else if(data === "Mar 28, 2020") {
            			chartData = {
            				executionDate: data,
               				passedTests: 6,
               				failedTests: 8
            		...
            		console.log('chart data to be drawn')
	...
	function drawExecutionChart (chartData) {
		...
		$(".execDetailsTCPassed").html(chartData.passedTests);
		$(".execDetailsTCFailed").html(chartData.failedTests);
		...
		historyExecutionChart = new Chart(ctx, {
		    ...
		    data: {
		        ...
		        datasets: [{
		            label: '# of tests',
		            data: [chartData.passedTests, chartData.failedTests],
		            backgroundColor: [
		                // '#1ABC9C',
		                // '#E74C3C'
		                '#a8edea',
	...
	function executionDateSelectHandler(e) {
		console.log('Execution Date Selected:')
	...
	function showTaskButtonHandler (e) {
		...
		currentTaskEndDate = data.endDate;
		
		// setting the end date of the test case date picker to be equal to last date of task
